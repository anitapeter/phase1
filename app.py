...
from generator import hashes, getTags, main1
from tset import main2
...
def predict(): 
    ...
    return render_template("results.html",image_name=filename,text=content,objects=contentobjk,last=h)
